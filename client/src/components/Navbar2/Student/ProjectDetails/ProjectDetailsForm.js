...
const ProjectDetailsForm = ({ currentId, setCurrentId, setNotify, setOpenPopup }) => {
    const [studPDData, setstudPDData] = useState({ department: "", semester: "", session: "", supervisor: "", title: "", description: "", potStakeholder: "", tool: "", team: "", teamMN:"", status: "pending" });
    ...
    return (
        <Container>
            {/* <form autoComplete="off" className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
                ...
                <TextField name="department" variant="outlined" required autoFocus label="Department" fullWidth value={studPDData.department} onChange={(e) => setstudPDData({ ...studPDData, department: e.target.value })} />
                <TextField name="semester" variant="outlined" required label="Semester" fullWidth value={studPDData.semester} onChange={(e) => setstudPDData({ ...studPDData, semester: e.target.value })} />
                <TextField name="session" variant="outlined" required label="Session" fullWidth value={studPDData.session} onChange={(e) => setstudPDData({ ...studPDData, session: e.target.value })} />
                <TextField name="supervisor" variant="outlined" required label="Supervisor" fullWidth value={studPDData.supervisor} onChange={(e) => setstudPDData({ ...studPDData, supervisor: e.target.value })} />
                ...
                <TextField name="description" variant="outlined" required label="Description" fullWidth value={studPDData.description} onChange={(e) => setstudPDData({ ...studPDData, description: e.target.value })} />
                <TextField name="potStakeholder" variant="outlined" required label="Potential Stakeholder" fullWidth value={studPDData.potStakeholder} onChange={(e) => setstudPDData({ ...studPDData, potStakeholder: e.target.value })} />
                ...
                <TextField name="teamMN" variant="outlined" required label="Team Member Matric Number" fullWidth value={studPDData.teamMN} onChange={(e) => setstudPDData({ ...studPDData, teamMN: e.target.value })} />
