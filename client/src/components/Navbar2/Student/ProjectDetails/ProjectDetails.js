...
const ProjectDetails = () => {
    ...
    return (
        <Grow in>
            ...
            <Typography variant="h5">This is my Project Title</Typography>
            <Typography variant="h6">Semester: This is Semester   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    Session: This is Session</Typography>
            <Typography variant="h6">Department: This is my department</Typography>
            <Typography variant="h6">Supervisor: This is my lecturer</Typography>
            <Typography variant="h6">Description: This is my description</Typography>
            <Typography variant="h6">Stakeholder: This is my stakeholder</Typography>
            <Typography variant="h6">Tools: This is my tool proficiency</Typography>
