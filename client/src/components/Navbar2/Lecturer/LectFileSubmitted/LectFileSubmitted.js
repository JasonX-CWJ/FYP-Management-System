        ...
        <Grow in>
            ...
            <Toolbar style={{ display: "flex", justifyContent: "space-between" }}>
                <Grid justify="space-between" container spacing={24}>
                    <Grid item>
                    <Typography variant="h5"> Files Submitted</Typography>
                    </Grid>
                    <Grid item>
            ...
            <TableContainer component={Paper}>
                ...
                <TableBody>
                    { lectFS.map((row) => (
                        <LectFileSubmittedDetails key={row._id} row={row} setConfirmDialog={setConfirmDialog} confirmDelete={confirmDelete} openForm={openForm} />
                    ))}
                </TableBody>
                </Table>
            </TableContainer>
